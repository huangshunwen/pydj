...
class ModelTest(TestCase):
    def setUp(self):
        Event.objects.create(id=1, name='wwww', status=True, limit=2000, address='shenzhen',
                             start_time='2018-04-01 17:11:24')
        Guest.objects.create(id=1, event_id=1, realname='alen', phone='13700000000',
                            email='alen@mail.com', sign=False)

    def test_event_models(self):
        result = Event.objects.get(name='wwww')
